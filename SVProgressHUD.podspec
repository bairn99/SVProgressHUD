Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/bairn99/SVProgressHUD'
  s.authors   = { 'Sam Vermette' => 'hello@samvermette.com', 'Tobias Totzek' => 'tobias@totzek.me' }
  s.source   = { :git => 'https://github.com/bairn99/SVProgressHUD.git', :tag => s.version.to_s }
  ...
  s.source_files = '*.{h,m}'
  s.resource_bundles = {'SVProgressHUD' => ['PrivacyInfo.xcprivacy']}
end
